...
export default async function NewVirtualGalleryPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-1 flex-col gap-6 px-4 py-9">
      <div>
        ...
        <h1 className="mt-2 text-xl font-semibold text-artego-black">New Virtual Gallery</h1>
      </div>
      ...
      {artworks.length === 0 ? (
        ...
        <NewGalleryForm artworks={artworks} />
      )}
    </div>
  );
}
