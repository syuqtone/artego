...
|---|---|---|---|
| Artworks per artist | 20 | 500 | Blocked at creation with a clear message |
...
| Publications per artist | 10 | Unlimited | Archived publications still count |
| Artworks per virtual gallery | 20 | 50 | Selection capped in the interface |
| AI generations | 50 / month | By plan | See ai-engine.md |
| PDF generations | 10 / month | By plan | Queued and counted |
